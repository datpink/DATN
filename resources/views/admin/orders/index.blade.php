                ...
                <div class="col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('orders.trash') }}" class="btn btn-sm btn-primary d-flex align-items-center">
                                <i class="bi bi-plus-circle me-2"></i> Thùng Rác
                            </a>
                        </div>
                                    ...
                                    <tbody>
                                        @forelse($orders as $index => $order)
                                            <tr>
                                                ...
                                                <td>
                                                    <strong class="badge bg-secondary">{{ $order->paymentMethod ? $order->paymentMethod->name : 'N/A' }}</strong>
                                                </td>
                                                <td>
                                                    <div class="actions">
                                                        <a
                                                            ...
                                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        @if (!in_array($order->status, ['shipped', 'canceled', 'refunded']))
                                                                            <button type="submit" class="btn btn-success" form="orderStatusForm{{ $order->id }}">Lưu thay đổi</button>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            </div>
